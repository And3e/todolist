...
export default function DnD({ done, taskList }) {
  ...
  function onDragEnd(result) {
    ...
    // update local
    let startDragOrder = taskList[result.source.index].dragOrder
    let endDragOrder = taskList[result.destination.index].dragOrder
    ...
    updateDB(taskList, result, tasks, setTasks, setDragStatus)
